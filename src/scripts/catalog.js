...
function loadCatalog(linkValue, nameValue, imageValue) {
  const categoryTemplate = document.querySelector(
    ".category-template"
  ).content;
  ...
  const categoryName = categoryElement.querySelector(".category-catalog__item-title");
  const categoryImage = categoryElement.querySelector(".category-catalog__item-img");
